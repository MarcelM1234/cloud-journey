...
In this project, I implemented identity security best practices in AWS by creating an administrative IAM user and discontinuing daily use of the root account. This exercise demonstrates foundational cloud security and access management skills.
